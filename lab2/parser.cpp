...
bool Parser::Parse()
{
	...
	bool is_end = false;
	TockenTableField tmp = { tocken_table[0].column, tocken_table[0].line, -2, "<signal-program>" };
	...
	while (!is_end)
	{
		...
		case ParseStages::ProcedureIdentifier:
			tmp = { tocken_table[current_tocken_position].column, tocken_table[current_tocken_position].line, -4, "<procedure-identifier>" };
			current_node = AddNode(current_node, tmp);
			current_stage = ParseStages::Identifier;
			break;
		case ParseStages::VariableIdentifier:
			tmp = { tocken_table[current_tocken_position].column, tocken_table[current_tocken_position].line, -5, "<variable-identifier>" };
			current_node = AddNode(current_node, tmp);
			current_stage = ParseStages::Identifier;
			break;
		case ParseStages::Identifier:
			...
			{
				tmp = { tocken_table[current_tocken_position].column, tocken_table[current_tocken_position].line, -6, "<identifier>" };
				current_node = AddNode(current_node, tmp);
				AddNode(current_node, tocken_table[current_tocken_position]);
				current_tocken_position++;
		...
		case ParseStages::BlockPreFirstPart:
			tmp = { tocken_table[current_tocken_position].column , tocken_table[current_tocken_position].line, -7, "<block>" };
			current_node = AddNode(current_node, tmp);
			return_nodes.push(current_node);
		...
		case ParseStages::LableDeclarationsFirstPart:
			tmp = { tocken_table[current_tocken_position].column , tocken_table[current_tocken_position].line, -8, "<label-declaration>" };
			current_node = AddNode(current_node, tmp);
		...
		case ParseStages::LabelsList:
			tmp = { tocken_table[current_tocken_position].column , tocken_table[current_tocken_position].line, -9, "<labels-list>" };
			current_node = AddNode(current_node, tmp);
			if (tocken_table[current_tocken_position].id == ',')
			{
				AddNode(current_node, tocken_table[current_tocken_position]);
		...
		case ParseStages::VariableDeclaration:
			tmp = { tocken_table[current_tocken_position].column , tocken_table[current_tocken_position].line, -10, "<variable-declaration>" };
			current_node = AddNode(current_node, tmp);
		...
		case ParseStages::DeclarationsList:
			tmp = { tocken_table[current_tocken_position].column , tocken_table[current_tocken_position].line, -11, "<declarations-list>" };
			current_node = AddNode(current_node, tmp);
			if (tocken_table[current_tocken_position].id > 1000)
			{
				return_nodes.push(current_node);
		...
		case ParseStages::DeclarationFirstPart:
			tmp = { tocken_table[current_tocken_position].column, tocken_table[current_tocken_position].line, -12, "<declaration>" };
			current_node = AddNode(current_node, tmp);
			next_stages.push(ParseStages::DeclarationSecondPart);
			return_nodes.push(current_node);
			tmp = { tocken_table[current_tocken_position].column, tocken_table[current_tocken_position].line, -13, "<variable-identifier>" };
			current_node = AddNode(current_node, tmp);
			current_stage = ParseStages::Identifier;
			break;
		...
		case ParseStages::Attribute:
			...
			{
				tmp = { tocken_table[current_tocken_position].column, tocken_table[current_tocken_position].line, -14, "<attribute>" };
				current_node = AddNode(current_node, tmp);
				AddNode(current_node, tocken_table[current_tocken_position]);
				current_tocken_position++;
				current_stage = ParseStages::Return;
		...
		case ParseStages::StatementsList:
			tmp = { tocken_table[current_tocken_position].column , tocken_table[current_tocken_position].line, -15, "<statements-list>" };
			current_node = AddNode(current_node, tmp);
		...
		case ParseStages::StatementFirstPart:
			tmp = { tocken_table[current_tocken_position].column , tocken_table[current_tocken_position].line, -16, "<statement>" };
			current_node = AddNode(current_node, tmp);
			return_nodes.push(current_node);
		...
		case ParseStages::ConditionStatementFirstPart:
			tmp = { tocken_table[current_tocken_position].column , tocken_table[current_tocken_position].line, -17, "<condition-statement>" };
			current_node = AddNode(current_node, tmp);
			return_nodes.push(current_node);
		...
		case ParseStages::IncompleteConditionStatementFirstPart:
			tmp = { tocken_table[current_tocken_position].column , tocken_table[current_tocken_position].line, -18, "<incomplete-condition-statement>" };
			current_node = AddNode(current_node, tmp);
			if (tocken_table[current_tocken_position].id == 408)
			{
				AddNode(current_node, tocken_table[current_tocken_position]);
		...
		case ParseStages::AlternativePart:
			tmp = { tocken_table[current_tocken_position].column , tocken_table[current_tocken_position].line, -19, "<alternative-part>" };
			current_node = AddNode(current_node, tmp);
		...
		case ParseStages::ConditionalExpressionFirstPart:
			tmp = { tocken_table[current_tocken_position].column , tocken_table[current_tocken_position].line, -20, "<conditional-expression>" };
			current_node = AddNode(current_node, tmp);
			return_nodes.push(current_node);
		...
		case ParseStages::Expression:
			tmp = { tocken_table[current_tocken_position].column , tocken_table[current_tocken_position].line, -21, "<expretion>" };
			current_node = AddNode(current_node, tmp);
			if (tocken_table[current_tocken_position].id > 1000)
			{
		...
		case ParseStages::UnsignedInteger:
			tmp = { tocken_table[current_tocken_position].column , tocken_table[current_tocken_position].line, -22, "<unsigned-integer>" };
			current_node = AddNode(current_node, tmp);
			if (tocken_table[current_tocken_position].id > 500)
			{
				AddNode(current_node, tocken_table[current_tocken_position]);
...
void Parser::ShowError(ofstream& os)
{
	os << error;
}
